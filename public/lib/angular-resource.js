...
angular.module('ngResource', ['ng']).
  factory('$resource', ['$http', '$parse', function($http, $parse) {
    ...
    Route.prototype = {
      setUrlParams: function(config, params, actionUrl, encoding/*PATCH support configurable url encoding params or not ORIGINAL without this parameter*/) {
        var self = this,
