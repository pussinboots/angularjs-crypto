...
describe('Controllers tests', function () {
    ...
    describe('encode query parameters', function () {
        ...
        it('encode query param by field name pattern', function () {
            $httpBackend.expectGET('/data/query/aes?name_enc=XJWoMnnOlSF3tFoU4jn4gg%3D%3D').respond(200, {
    ...
    describe('encode complete request query params', function () {
        ...
        it('encode complete get request query params', function () {
            $httpBackend.expectGET('/data/fullquery/aes?query=WZM2hwPXWx4%2B7SbaJpUPrh6KZl7c4lqZ%2F67En5tJy8DGTjW%2BmxDV0g8t2UtDklW4f1Ec%2Fmr6hPf2K6V%2BoE%2F21A%3D%3D').respond(200, {
